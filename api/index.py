    ...
    "reasoning": {{
        ...
        completion = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system", 
                    "content": "You are a JSON-only response bot. Return ONLY valid JSON. Start with { and end with }."
                },
        ...
        if not cleaned:
            fallback_response = {
                ...
                "reasoning": {
                    "syntactic_analysis": "Could not parse response",
...
# ✅ Required for Vercel - DO NOT use app.run()